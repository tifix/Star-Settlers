...
{$R *.dfm}
 ...
 begin
                    if x=40 then if y=50 then         //special quest destiation
                        begin
                        mapgenerator [40,50]:=2;
                        mapgen [40,50]:=true;
                        ironore[40,50]:=false;
                        waterore[40,50]:=true;
                        copperore[40,50]:=false;
                        uraniumore[40,50]:=false;
                        platinumore[40,50]:=false;
                        end;
 ...
 if x=1000 then x:=0;
  label3.Caption:=x.ToString+'           '+y.ToString;
   ...
   if mapgenerator [x,y]=1 then
       begin
       Image_Window.picture.LoadFromFile('window_empty.jpg');
       Form2.showmodal;
       end;
   if mapgenerator [x,y]=2 then
       begin
       Image_Window.picture.LoadFromFile('window_set.jpg');
       Form4.ShowModal;
       end;
   if mapgenerator [x,y]= 3 then
       begin
       Image_Window.picture.LoadFromFile('window_own.jpg');
       form5.ShowModal;
       end;
   if mapgenerator[x,y]=4 then
       begin
       Image_Window.picture.LoadFromFile('window_pir.jpg');
       Form6.ShowModal;
       end;
   if mapgenerator[x,y]=5 then
       begin
       Image_Window.picture.LoadFromFile('window_alien.jpg');
       Form8.ShowModal;
       end;
